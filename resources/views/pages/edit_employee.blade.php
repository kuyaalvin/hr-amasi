	...
	{{ method_field('patch') }}
		...
		<div class="form-row">
			...
			<div class="form-group col">
				...
				<input type="text" class="form-control" id="referred_by" name="referred_by" value="{{ old('referred_by' , $employee->referred_by) }}">
			</div>
			<div class="form-group col">
				<label for="Referred by">Mother's Maiden Name: </label>
				<input type="text" class="form-control" id="mothers_maiden_name" name="mothers_maiden_name" value="{{ old('mothers_maiden_name' , $employee->mothers_maiden_name) }}">
			</div>
			<div class="form-group col">
			...
			<div class="form-group col">
				...
				<input type="text" class="form-control" id="emergency_contact_number" name="emergency_contact_number" value="{{ old('emergency_contact_number' , $employee->emergency_contact_number) }}">
			</div>
