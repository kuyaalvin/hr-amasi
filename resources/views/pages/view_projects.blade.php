...
dom: "<'row'<'col-sm-12 col-md-6'l><'col-sm-12 col-md-6'<\"#filter\">>><'row'<'col-sm-12'tr>><'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>",
        ...
        columns: [
        	{data: 'name',
                ...
                return '<a href="'+prefixUrl+row.project_id+'/profile" id="full_name">' + row.name+ '</a>';
                }
          },
        	{data: 'address'},
        	{data: 'time_in'},
          ...
          {data: 'transfer', searchable: false, orderable: false,
            render: function(data, type, row) {
            return '<a class="btn btn-success" href="'+prefixUrl+row.project_id+'/view_transfer">Transfer</a>';
            }
            },
